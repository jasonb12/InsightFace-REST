...
def test_image(image_path, output_prefix):
    ...
    try:
        response = requests.post('http://localhost:18081/extract', json=data, timeout=30)
...
if __name__ == '__main__':
    ...
    print('ARM64 Jetson AGX Orin deployment:')
    print('✅ L4T JetPack 6.2 container')
    print('✅ TensorRT optimization on Jetson GPU')
    print('✅ SCRFD 10G + glintr100 models')
    print('✅ Face detection and recognition working') 